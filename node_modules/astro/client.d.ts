...
declare module 'astro:assets' {
	...
	type AstroAssets = {
		...
		getConfiguredImageService: typeof import('astro/assets').getConfiguredImageService;
		inferRemoteSize: typeof import('astro/assets/utils').inferRemoteSize;
		Image: typeof import('astro/components/Image.d.astro.js').default;
		Picture: typeof import('astro/components/Picture.d.astro.js').default;
		Font: typeof import('astro/components/Font.d.astro.js').default;
		getFontData: (
	...
	type ImgAttributes = import('./dist/type-utils.js').WithRequired<
		Omit<import('astro/types').HTMLAttributes<'img'>, 'src' | 'width' | 'height'>,
		'alt'
	>;
...
declare module '*.svg' {
	const Component: import('astro/types').SvgComponent & ImageMetadata;
	export default Component;
}

declare module 'astro:transitions' {
	type TransitionModule = typeof import('astro/virtual-modules/transitions.js');
	export const slide: TransitionModule['slide'];
	export const fade: TransitionModule['fade'];
	export const createAnimationScope: TransitionModule['createAnimationScope'];

	type ClientRouterModule = typeof import('astro/components/ClientRouter.d.astro.js');
	/**
...
declare module 'astro:transitions/client' {
	type TransitionRouterModule = typeof import('astro/virtual-modules/transitions-router.js');
	...
	export type Fallback = import('astro/virtual-modules/transitions-types.js').Fallback;
	export type Direction = import('astro/virtual-modules/transitions-types.js').Direction;
	// biome-ignore format: bug
	export type NavigationTypeString = import('astro/virtual-modules/transitions-types.js').NavigationTypeString;
	export type Options = import('astro/virtual-modules/transitions-types.js').Options;

	type EventModule = typeof import('astro/virtual-modules/transitions-events.js');
	...
	// biome-ignore format: bug
	export type TransitionBeforePreparationEvent = import('astro/virtual-modules/transitions-events.js').TransitionBeforePreparationEvent;
	// biome-ignore format: bug
	export type TransitionBeforeSwapEvent = import('astro/virtual-modules/transitions-events.js').TransitionBeforeSwapEvent;
	...
	// biome-ignore format: bug
	type TransitionSwapFunctionModule = typeof import('astro/virtual-modules/transitions-swap-functions.js');
