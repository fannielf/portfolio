import type { ToolbarAppEventTarget, ToolbarServerHelpers } from 'astro/runtime/client/dev-toolbar/helpers.js';
import type { AstroDevToolbar, DevToolbarCanvas } from 'astro/runtime/client/dev-toolbar/toolbar.js';
import type { Icon } from 'astro/runtime/client/dev-toolbar/ui-library/icons.js';
import type { DevToolbarBadge, DevToolbarButton, DevToolbarCard, DevToolbarHighlight, DevToolbarIcon, DevToolbarRadioCheckbox, DevToolbarSelect, DevToolbarToggle, DevToolbarTooltip, DevToolbarWindow } from 'astro/runtime/client/dev-toolbar/ui-library/index.js';
declare global {
